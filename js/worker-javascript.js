...
define('ace/mode/javascript/jshint', ['require', 'exports', 'module'], function (
  require,
  exports,
  module,
) {
          ...
          (function (global) {
            (function () {
              ...
              typedArrayTags[argsTag] = typedArrayTags[arrayTag] = typedArrayTags[
                arrayBufferTag
              ] = typedArrayTags[boolTag] = typedArrayTags[dateTag] = typedArrayTags[
                errorTag
              ...
              cloneableTags[argsTag] = cloneableTags[arrayTag] = cloneableTags[
                ...
                float32Tag
              ] = cloneableTags[float64Tag] = cloneableTags[int8Tag] = cloneableTags[
                int16Tag
              ] = cloneableTags[int32Tag] = cloneableTags[numberTag] = cloneableTags[
                objectTag
              ] = cloneableTags[regexpTag] = cloneableTags[stringTag] = cloneableTags[
                uint8Tag
              ] = cloneableTags[uint8ClampedTag] = cloneableTags[uint16Tag] = cloneableTags[
                uint32Tag
              ] = true;
                ...
                if (length == 1) {
                  ...
                  if (isStrictComparable(value)) {
                    return function (object) {
                      ...
                      return (
                        object[key] === value && (value !== undefined || key in toObject(object))
                      );
                    };
                  }
                }
              ...
              function clone(value, isDeep, customizer, thisArg) {
                ...
                customizer =
                  typeof customizer == 'function' && bindCallback(customizer, thisArg, 1);
            ...
            (function (x) {
              ...
              prefix('yield', function () {
                ...
                if (state.inES6(true) && !state.funct['(generator)']) {
                  if (
                    !(
                      '(catch)' === state.funct['(name)'] && state.funct['(context)']['(generator)']
                    )
                  ) {
        ...
        function (_dereq_, module, exports) {
          ...
          Lexer.prototype = {
            ...
            inContext: function (ctxType) {
              return (
                this.context.length > 0 && this.context[this.context.length - 1].type === ctxType
              );
            },
            ...
            scanTemplateLiteral: function (checks) {
              ...
              tokenType =
                tokenType === Token.TemplateHead ? Token.NoSubstTemplate : Token.TemplateTail;
              this.skip(1);
...
define('ace/lib/es5-shim', ['require', 'exports', 'module'], function (require, exports, module) {
  ...
  if (!Array.prototype.indexOf || [0, 1].indexOf(1, 2) != -1) {
    Array.prototype.indexOf = function indexOf(sought /*, fromIndex */) {
      var self =
          splitString && _toString(this) == '[object String]' ? this.split('') : toObject(this),
        length = self.length >>> 0;
  ...
  if (!Object.getPrototypeOf) {
    Object.getPrototypeOf = function getPrototypeOf(object) {
      return (
        object.__proto__ || (object.constructor ? object.constructor.prototype : prototypeOfObject)
      );
    };
  }
